...
class ImageApiFragment @Inject constructor(
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        //EditText'te sürekli harfler girilmesi sonucu program çökebilir.
        //O yüzden Delay kullanmamız lazım.
        //Delay kullanmamız için de coroutine'lere ihtiyacımız var bu yüzden "job" türetiyoruz.
        var job: Job? = null

        //EditText'te yapılan her değişiklikte bu çağırılacak
